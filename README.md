...
- A Mendix app with the newest versions of these modules: GenAI Commons, Bedrock Connector, Conversational UI. We use the [GenAI Showcase App]([App Login - Error](https://marketplace.mendix.com/link/component/220475)) as example.
...
Keep in mind: computer use is still in beta for most major LLM providers, including [OpenAI](https://platform.openai.com/docs/guides/tools-computer-use) and Amazon Bedrock, so things are changing fast. 
